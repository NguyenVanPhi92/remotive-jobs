...
import { getJobsCategories, getJobsByCategory, getJobsPerPage } from '../../lib/api'
...
export default function CategoryPage({
    ...
    return (
        <>
            <SEO {...getSeoData()} />
            <Hero categories={categories} selectedCategory={category} search={search} />
            <main className={styles['main']}>
                <Filter
                    ...
                    locations={locations}
                />
                <Jobs className={styles['main__jobs']} {...{ jobs, totalPages, currentPage }} />
            </main>
        </>
    )
}
